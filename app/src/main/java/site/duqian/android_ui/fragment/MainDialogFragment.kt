...
import site.duqian.android_ui.utils.*
...
class MainDialogFragment : BaseFragment() {
    ...
    private fun handleAnimation() {
        val visible = ivTestImage.isVisible
        Log.d("dq-dialog", "visible=$visible")
        ivTestImage.setViewVisible(true)
        //rect1=Rect(686, 324 - 1104, 381) rect=Rect(48, 48 - 768, 1071)
        val rect1 = Rect()
        tvTitle.getGlobalVisibleRect(rect1)
        Log.d("dq-dialog", "visible=${ivTestImage.isVisible},rect1=$rect1")
    ...
    private fun startTranslationAnimation(view: View) {
        ...
        val dp2px = 30.dp //UIUtils.dp2px(context, 30f)
        var dxx = 1
